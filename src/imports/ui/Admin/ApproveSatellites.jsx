...
export const ApproveSatellites = () => {
  ...
  const [satsDeleted, satsAdminCheck, satsMachineCheck, satsBothCheck, isLoading] = useTracker(() => {
    ...
    return [satsDeleted, satsAdminCheck, satsMachineCheck, satsBothCheck, !sub.ready()];
  });
            ...
            <TableRow color="secondary">
              ...
              <TableCell className={classes.adminReview} align="center">
                <span className={classes.filterableHeader}>
                  ...
                  <IconButton size="small" onClick={() => setViewAdminCheck(!viewAdminCheck)}>
                    {viewAdminCheck ? <VisibilityIcon fontSize="small" /> : <VisibilityOffIcon fontSize="small" />}
                  </IconButton>
                </span>
              </TableCell>
