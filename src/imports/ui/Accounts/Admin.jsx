...
export const Admin = () =>{
    ...
    const [roles, rows, users, loading] = useTracker(() => {
        ...
        const rows = users.map((user) => {
            ...
            roles: Roles.getRolesForUser(user._id).map((role) => role).join(", ")
          };
        });
      ...
      const addUserToRole = (user, role) =>{
        Meteor.call("addUserToRole", user, role, (res, err) => console.log(res, err))
      }
    ...
    return(
        ...
        >
        <DialogTitle id="alert-dialog-title">Manage {editUser.username}</DialogTitle>
        <DialogContent>
            <DialogContentText id="alert-dialog-description">
                <b>Roles</b>
                <br/>
                {Roles.getRolesForUser(editUser._id).map((role) =>{
                    return(
                        <p>
                        {role}
                        <Button
