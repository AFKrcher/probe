    ...
    import FavoritesSwitch from "../DataDisplays/FavoritesSwitch";
    ...
    export const Favorites = () =>{
      ...
      const [sortFavorites, setSortFavorites] = useState(0);
      const [selector, setSelector] = useState({noradID: { $in: Meteor.user().favorites }});
      ...
      const decideSort = () => {
        ...
        if(sortFavorites) return {noradID: sortFavorites}
      };
        ...
        <React.Fragment>
          ...
          <div className={classes.root}>
            <Grid container justifyContent="space-between" alignItems="center">
              <Grid item xs>
                <Typography variant="h3">Favorite Satellites</Typography>
              </Grid>
              {width > 650 ? (
